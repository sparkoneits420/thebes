 ...
 * random numbers.<br> ISAAC has been designed to be cryptographically secure
 * and is inspired by RC4.<br> Cycles are guaranteed to be at least
 * 2<sup>40</sup> values long, and they are 2<sup>8295</sup> values long on
 * average.<br> The results are uniformly distributed, unbiased, and
 * unpredictable unless you know the seed.<br> <br> This is the original
 * implementation by Bob Jenkins with some minor changes.<br> <br>
 * <b>Changelog:</b><br> <ul> <li>050325: Added
 * <code>supplementSeed(int[] seed )</code> method; made all variables
 * private</li> <li>050320: Use
 * <code>System.arraycopy()</code> in
 * <code>ISAACAlgorithm(int[] seed)</code></li> <li>980224: Translate to
 * Java</li> <li>970719: Use context, not global variables, for internal
 * state</li> <li>960327: Creation (addition of randinit, really)</li> </ul>
 *
 * @author Bob Jenkins
 * @version 050325
 */
public class StreamSecurity {
     ...
     * seed.<br> Equivalent to
     * <code>randinit(ctx,FALSE)</code> in the C implementation.
     */
    public StreamSecurity() {
        mem = new int[SIZE];
        rsl = new int[SIZE];
     ...
     * user-provided seed.<br> Equivalent to
     * <code>randinit(ctx, TRUE)</code> after putting seed in
     * <code>randctx</code> in the C implementation.
     *
     * @param seed The seed.
     */
    public StreamSecurity(int[] seed) {
        mem = new int[SIZE];
        rsl = new int[SIZE];
    ...
    /**
     * Generate 256 results.<br> This is a small (not fast) implementation.
     */
     ...
     *
     * @param flag If
     * <code>true</code> then use the seed (which the constructor placed in
    ...
    /**
     * Reseeds this random object.<br> The given seed supplements (using bitwise
